...
print("Inspecting Google GenAI SpeakerVoiceConfig...")

try:
    print_type_details("types.SpeakerVoiceConfig", types.SpeakerVoiceConfig)
except AttributeError:
    print("types.SpeakerVoiceConfig not found")
